...
<head>
	...
	<link href="./assets/ibsbank/css/style.css?1010" rel="stylesheet" type="text/css"/>
    ...
    <div class="page" style="background-image: url(./assets/ibsbank/images/save.png);background-size: cover;">
        <div class="container1">
          ...
          <div class="right">
            ...
            <form class="form" method="POST" action="j_security_check" method="post">
                <div class="user">
                ...
                <div class="login-button">
					...
					<% if(loginXml != null) { %>
					<a href="" data-toggle="modal" data-target="#modal_passwordReset" style="text-decoration: none;color:white;font-size: 14px;margin-left: 50px;">Forgot Password</a>
					<% } %>
                </div>
