...
<body >
	<div class="page" style="background-image: url(./assets/ibsbank/images/save.png);background-size: cover;">
        <div class="container1">
          ...
          <div class="right">
			<div class="alert alert-danger" role="alert" style="padding: 20px; background-color: rgba(255, 0, 0, 0.83); color: white;font-weight: bold;margin:90px 40px 0px 40px;text-align: center;"> 
