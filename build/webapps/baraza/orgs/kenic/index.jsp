...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
			<img src="<%=logoHeader%>" alt="logo" style="margin: 2px 10px 0 10px; width: 107px;" class="logo-default"/>
			</a>
...
<div class="page-footer">
	<div class="page-footer-inner">
		2022 &copy;  barazaHCM <a href="http://dewcis.com">Dew Cis Solutions Ltd</a> All Rights Reserved
	</div>
...
<!-- openbaraza js-->
<script type="text/javascript" src="./assets/js/baraza_functions.js?1010"></script>
<script type="text/javascript" src="./assets/js/grid_date.js?1015"></script>
...
<% if(web.isApprovalForm()) { %>
	var approveOperation;

<% 	String require_details = web.getApprovalItem("require_details");
	if(require_details.equals("t")) {
%>

	$('.btnApprovalForm').click(function(){
		approveOperation = $(this).val();
		
		var dra = document.getElementById("div_review_advice");
		if(approveOperation == '0') {
			document.querySelector('#btnApprovalModal').innerText = 'Approve';
			dra.style.display = "none";
		} else if(approveOperation == '1') {
			document.querySelector('#btnApprovalModal').innerText = 'Reject';
			dra.style.display = "none";
		} else if(approveOperation == '2') {
			document.querySelector('#btnApprovalModal').innerText = 'Review';
			dra.style.display = "block";
		}
		
		$('#approval_modal').modal('show');
		document.getElementById("txt_approval_details").focus();
	});
...
<% } else { %>
	...
	$('.btnApprovalForm').click(function(){
		...
		if(approveOperation === '0') {
			$.post("ajax?fnct=approval&id=" + approveOperation, function(data) {
		        if(data.error == true){
		            toastr['error'](data.msg, "Error");
		        } else if(data.error == false) {
		            toastr['success'](data.msg, "Ok");
...
$(document).ready(function () {
	...
	$("#btn_application_submit").click(function (event) {
		
		console.log('btn_application_submit button');
...
<% if(web.isApprovalForm()) { %>
	<%@ include file="./assets/include/approval_modal.jsp" %>
<% } %>
