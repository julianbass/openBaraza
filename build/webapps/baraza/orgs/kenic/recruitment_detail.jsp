...
<head>
	...
	<!-- END THEME STYLES -->
	<link rel="icon" href="https://kenic.or.ke/wp-content/uploads/2023/04/cropped-Kenic-Fav-192x192.png" sizes="192x192" />
	<link rel="apple-touch-icon" href="https://kenic.or.ke/wp-content/uploads/2023/04/cropped-Kenic-Fav-180x180.png" />
	<meta name="msapplication-TileImage" content="https://kenic.or.ke/wp-content/uploads/2023/04/cropped-Kenic-Fav-270x270.png" />
	...
	<link href="./assets/css/recruitment_detail.css?12" rel="stylesheet" type="text/css"/>
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-sidebar-closed-hide-logo page-footer-fixed">
	...
	<div class="page-header navbar navbar-fixed-top">
		...
		<div class="page-header-inner">
			...
			<div class="page-logo">
				<a href="index.jsp">
					<img src="./assets/kenic/images/kenic_logo@3x.png" alt="logo" style="margin: 3px 10px 0 10px; width: 77px;" class="logo-default">
				</a>
								...
								<div class="row">
									...
									<div class="small-12 large-6 columns">
										<label style="font-size: 15px;"> <span style="font-size: 14px;font-weight: bold;">What's your email address?*</span><br><br>
											...
											width: 330px;
											padding: 8px;">
											<input id="nf-field-4" onclick="job_application()" class="ninja-forms-field nf-element" type="button" value="APPLY NOW" style="background-color: #eb0029;
											color: white;
											border: none;
											padding: 8px;">
										</label>
...
<script type="text/javascript" src="./assets/js/recruitment_detail.js?1011"></script>
...
<script type="text/javascript">
	...
	function job_application() {
		...
		if(!is_concent.is(":checked")) {
			let checkEmailError = "<div style='color:red'><i class='glyphicon glyphicon-remove'></i>For you to proceed read the RECRUITMENT CONSENT details and tick bellow to concent</div>";
