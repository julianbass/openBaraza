...
<head>
	...
	<link href="./assets/css/recruitment.css?130" rel="stylesheet" type="text/css"/>
...
<div class="page-header navbar navbar-fixed-top" style="background-color: #fafafa;border-bottom:none;">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
				<img src="./assets/kenic/images/kenic_logo@3x.png" alt="logo" style="margin: -20px 10px 0 10px; width: 77px;" class="logo-default">
			</a>
