...
<head>
	...
	<!--===============================================================================================-->
		...
		<link rel="stylesheet" type="text/css" href="./assets/peaksventures/css/main.css?14">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST" action="j_security_check" method="post">
					<center><img src="./assets/peaksventures/images/logo.png?1012" alt="logo"></center>

					<div class="wrap-input100 validate-input" data-validate = "Username is required">
						<input class="input100" type="text" id="j_username" name="j_username" required>
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						...
						<input class="input100" type="password" id="j_password" name="j_password" required>
					...
					<div class="text-center p-t-115">
						<a class="txt2" href="" data-toggle="modal" data-target="#modal_passwordReset">
							Forgot Password?
						</a>
					</div>
					<% } %> 
...
<!-- <script src="./assets/evereign/js/jquery.min.js"></script> -->
...
<jsp:include page="./assets/include/calendar.jsp"></jsp:include>
</body>
<!-- END BODY -->
</html>
