...
<head>
	...
	<link href="./assets/css/peaksventures/recruitment_detail.css?12" rel="stylesheet" type="text/css"/>
								...
								<div class="row">
									...
									<div class="small-12 large-6 columns">
										<label style="font-size: 15px;"> <span style="font-size: 14px;font-weight: bold;">What's your email address?*</span><br><br>
											...
											width: 330px;
											padding: 8px;">
											<input id="nf-field-4" onclick="job_application()" class="ninja-forms-field nf-element" type="button" value="APPLY NOW" style="background-color: #28aa4a;
											color: white;
											border: none;
											padding: 8px;">
										</label>
...
<script type="text/javascript" src="./assets/js/peaksventures/recruitment_detail.js?1011"></script>
