...
<head>
	<meta charset="utf-8"/>
	<title>Peaks Ventures | Recruitment</title>
	...
	<link href="./assets/css/peaksventures/recruitment.css?1011" rel="stylesheet" type="text/css"/>
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
			<img src="./assets/peaksventures/images/logo.png" alt="logo" style="margin: 5px 10px 0 10px; width: 80%;" class="logo-default"/>
			</a>
...
<script type="text/javascript" src="./assets/js/peaksventures/recruitment_api.js?1092"></script>
