...
<head>
    ...
    <link href="./assets/admin/layout4/css/custom.css?1122" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN HEADER -->
<div class="page-header navbar navbar-fixed-top" style="background-color: #f5f7fa;">
	<!-- BEGIN HEADER INNER -->
	<div class="page-header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo">
			<a href="index.jsp">
			<img src="./assets/peaksventures/images/logo.png" alt="logo" style="margin: -15px 10px 0 10px; width: 80%;" class="logo-default"/>
			</a>
			
		</div>
		<!-- END LOGO -->
		<!-- BEGIN RESPONSIVE MENU TOGGLER -->
		<h2 class="ptopheader" style="margin-left: 45%;font-weight: bold;">TRAINING</h2>
...
<div class="page-container" style="background-color: white;">
	...
	<div class="page-content-wrapper">
		<div class="page-content" style="margin-left: 0px;padding:0;margin-top:30px">
                        ...
                        <section class="single_training" id="tableid">
	                        <div class="row">
	                            <div class="small-12 columns">
	                                <div id="training_name" class="training_title" style="font-size: 27px;font-weight: bold;">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
									<!-- <a href="./trainings.jsp"><button class="allcbtn">VIEW ALL COURSES</button></a> -->

									<hr style="border-top: 2px solid #28aa4a;width: 50px;margin-top: 10px;margin-bottom: 20px;">
									<div class="img-tbl" style="display:flex">
										<div id="top-img" style="max-width:600px;width:100%;background-image: url(https://img.freepik.com/premium-photo/stack-books-desk-back-school_488220-35508.jpg?w=740);background-size: cover;">
											<div id="topic-img" style="max-width:600px;width:100%"></div>
										</div>
										<div class="table-container">
											<ul class="responsive-table">
											  <li class="table-header" style="background-color: #28aa4a;">
												<div style="margin:auto">Online Training Details</div>
											  </li>
											  <li class="table-row">
												<div class="col col-1" data-label="Training Date">Start On</div>
												<div class="col col-2" id="start_date" data-label="Date"></div>
											  </li>
											  <li class="table-row">
												<div class="col col-1" data-label="Training Time">Start Time</div>
	                        ...
	                        <div class="row">
								<h4 style="font-weight: bold;">TOPIC OVERVIEW</h4>
								<hr style="border-top: 2px solid #28aa4a;width: 50px;margin-top: 10px;margin-bottom: 20px;">
                                    ...
                                    <label style="font-size: 15px;"> 
										...
										<!-- <div class="nf-field-element"> -->
											<input id="nf-field-4" 
											 ...
											 class="ninja-forms-field nf-element" type="button" value="APPLY NOW"  style="
...
<script type="text/javascript" src="./assets/js/training.js?1060"></script>
