...
<div class="page-header navbar navbar-fixed-top" style="background-color: #f5f7fa;">
	...
	<div class="page-header-inner">
		...
		<h2 class="ptopheader" style="margin-left: 45%;font-weight: bold;">COURSE TOPICS</h2>
		<!-- END LOGO -->
...
<div class="page-container" style="background-color: white;">
	...
	<a href="./trainings.jsp"><button class="backbtn" style="background-color: #28aa4a;">← BACK TO COURSES</button></a>
...
<script type="text/javascript" src="./assets/js/trainings_detail.js?1082"></script>
