...
<!-- BEGIN HEADER -->
<div class="page-header navbar navbar-fixed-top" style="border-bottom: none;background-color: #f5f7fa;">
	<!-- BEGIN HEADER INNER -->
	<div class="page-header-inner">
		...
		<h2 class="ptopheader" style="margin-left: 45%;font-weight: bold;">TOPIC DETAILS</h2>
		<!-- END LOGO -->
                        ...
                        <section class="single_training" id="tableid">
	                        <div class="row">
	                            <div class="small-12 columns">
									...
									<a href="./trainings.jsp"><button class="allcbtn" style="background-color: #28aa4a;">VIEW ALL COURSES</button></a>
										...
										<div class="table-container">
											<ul class="responsive-table">
											  <li class="table-header" style="background-color: #28aa4a;">
												<div style="margin:auto">Online Class Details</div>
											  </li>
											  <li class="table-row">
...
<script type="text/javascript" src="./assets/js/single_training.js?1060"></script>
