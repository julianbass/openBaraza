...
<head>
	...
	<link rel="stylesheet" href="./assets/irm/css/style.css?121">
	...
	<link rel="icon" href="./assets/irm/images/favicon.png"/>

</head>

<!-- END HEAD -->
<!-- BEGIN BODY -->
<body style="background-image: url('./assets/irm/images/bg.png') !important; background-size: 100% 100vh !important;">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						<center><img src="./assets/irm/images/logo.png" width="80%" style="margin-bottom: 10px;"></center>
...
<!-- END PAGE LEVEL PLUGINS -->
  <script src="./assets/irm/js/main.js"></script>
