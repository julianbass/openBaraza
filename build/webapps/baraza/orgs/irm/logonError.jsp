...
<head>
	...
	<link rel="stylesheet" href="./assets/irm/css/style.css?112">
...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body style="background-image: url('./assets/irm/images/bg.png') !important; background-size: cover !important;">
