...
<head>
	...
	<link href="./assets/admin/layout4/css/custom.css?1020" rel="stylesheet" type="text/css"/>
	<link href="./assets/css/app.css?1031" rel="stylesheet" type="text/css"/>
	<link href="./assets/css/recruitment.css?1030" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN HEADER -->
<div class="page-header navbar navbar-fixed-top" style="background-color: #68b445;height: 80px;">
	<!-- BEGIN HEADER INNER -->
	<div class="page-header-inner">
		<!-- BEGIN LOGO -->
		<div class="page-logo" style="transform:perspective(300px) rotateX(-30deg);transform-origin: 0% 50%;background-color: white;height: 90px;margin-top: -2px;margin-left: -2px;">
			<a href="index.jsp">
			<img src="./assets/mna/images/logo.png" alt="logo" style="margin: 5px 10px 0 10px; width: 200px;" class="logo-default"/>
			</a>
		...
		<h2 class="ptopheader" style="display: inline-block;margin-left: 23%;">VACANCIES</h2>
			...
			<div class="row" style="max-width: 100%;">
				...
				<div class="portlet light bordered" style="border: none !important;box-shadow: none;">
					...
					<div class="portlet-body">
						...
						<!-- RESULTS SECTION -->
						<section class="results">
							<div class="row" style="max-width: 100%;display: flex;">
							    <div class="small-12 columns" id="internship_list" style="display: flex;gap: 50px;flex-wrap: wrap;">
							        <i class="fas fa-sync fa-spin"> </i>
							    </div>
							</div>
						</section>
...
<script type="text/javascript" src="./assets/js/recruitment_api.js?1081"></script>
...
<script type="text/javascript">
	...
	$("#btn_application").click(function(e) {
		...
		$.post('ajaxinsert', {app_xml:app_xml, app_key:'1:0', form_data:form_data}, function(data) {
			...
			if(data.error == 0) {
				$('.modal').modal('hide');
				let applyMsg = "<div style='color:blue'><i class='glyphicon glyphicon-ok'></i>" + data. msg + "</div>";
				$('#div_msg').html(applyMsg);
			} else {
				$('.modal').modal('hide');
				let applyMsg = "<div style='color:red'><i class='glyphicon glyphicon-remove'></i>" + data.error_msg + "</div>";
				$('#div_msg').html(applyMsg);
			}
		});
	});
