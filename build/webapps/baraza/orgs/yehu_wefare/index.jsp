...
<%
	...
	allowXml.add("yehu_welfare.xml"); allowXml.add("hr.xml"); allowXml.add("payroll.xml"); allowXml.add("attendance.xml"); 
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
			<img src="./assets/yehu/images/logo.jpg?1020" alt="logo" style="margin: 2px 10px 0 30px; width: 45%;" class="logo-default"/>
			</a>
