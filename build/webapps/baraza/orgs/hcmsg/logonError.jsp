...
<head>
	...
	<link rel="stylesheet" href="./assets/hcmsg/css/style.css?13">
	...
	<link rel="icon" href="https://hcmsg.org/wp-content/uploads/2021/02/cropped-hcmsg-logo-tr-32x32.png" sizes="32x32" />
<link rel="icon" href="https://hcmsg.org/wp-content/uploads/2021/02/cropped-hcmsg-logo-tr-192x192.png" sizes="192x192" />
<link rel="apple-touch-icon" href="https://hcmsg.org/wp-content/uploads/2021/02/cropped-hcmsg-logo-tr-180x180.png" />
<meta name="msapplication-TileImage" content="https://hcmsg.org/wp-content/uploads/2021/02/cropped-hcmsg-logo-tr-270x270.png" />

</head>
    
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body style="background-image: url('./assets/hcmsg/images/backgroud.jpg') !important; background-size: cover !important;">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						<center><img src="./assets/hcmsg/images/logo.png" width="180px" style="margin-bottom: 30px;"></center>
...
<script src="./assets/hcmsg/js/popper.js"></script>
  <script src="./assets/hcmsg/js/main.js"></script>
