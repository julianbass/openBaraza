...
<div class="page-header navbar navbar-fixed-top" style="border-bottom: none;background-color: #022a30;padding: 16px 0px 16px 0px;height: 116px;">
	...
	<div class="page-header-inner">
		...
		<!-- BEGIN PAGE TOP -->
		<h2 style="color:#fff;font-weight: bold;margin-left: 45%;">COURSE TOPICS</h2>
		<!-- END PAGE TOP -->
	</div>
	<!-- END HEADER INNER -->
</div>
...
<div class="page-container" style="margin-top: 115px;background-color: white;">
	...
	<a href="./trainings.jsp"><button class="backbtn" style="background-color: #db8b00;">← BACK TO COURSES</button></a>
...
<script type="text/javascript" src="./assets/js/eagle-hr/trainings_detail.js?1092"></script>
