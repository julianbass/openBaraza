...
<div class="page-header navbar navbar-fixed-top" style="border-bottom: none;background-color: #022a30;padding: 16px 0px 16px 0px;height: 116px;">
	...
	<div class="page-header-inner">
		...
		<!-- BEGIN PAGE TOP -->
		<h2 style="color:#fff;font-weight: bold;margin-left: 45%;">TOPIC DETAILS</h2>
		<!-- END PAGE TOP -->
	</div>
	<!-- END HEADER INNER -->
</div>
                        ...
                        <section class="single_training" id="tableid">
	                        <div class="row">
	                            <div class="small-12 columns">
									...
									<a href="./trainings.jsp"><button class="allcbtn" style="background-color: #db8b00;">VIEW ALL COURSES</button></a>

									<hr style="border-top: 2px solid #db8b00;width: 50px;margin-top: 10px;margin-bottom: 20px;">
									<div class="img-tbl" style="display:flex">
										...
										<div class="table-container">
											<ul class="responsive-table">
											  <li class="table-header" style="background-color: #db8b00;">
...
<script type="text/javascript" src="./assets/js/eagle-hr/single_training.js?1070"></script>
