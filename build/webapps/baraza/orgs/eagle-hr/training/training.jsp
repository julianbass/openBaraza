...
<head>
	<meta charset="utf-8"/>
	<title>Eagle HR Consultants | Training</title>
...
<div class="page-header navbar navbar-fixed-top" style="background-color: #f5f7fa;">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
			<img src="./assets/ibsbank/images/logo.png" alt="logo" style="margin: 20px 10px 0 10px; width: 107px;" class="logo-default"/>
			</a>
			
		</div>
		<!-- END LOGO -->
		<!-- BEGIN RESPONSIVE MENU TOGGLER -->
		<h2 class="ptopheader">TRAINING</h2>
                        ...
                        <section class="single_training" id="tableid">
	                        <div class="row">
	                            <div class="small-12 columns">
									...
									<hr style="border-top: 2px solid #f6a000;width: 50px;margin-top: 10px;margin-bottom: 20px;">
