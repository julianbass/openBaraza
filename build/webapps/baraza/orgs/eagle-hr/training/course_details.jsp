...
<%
	...
	if(loginXml != null) {
		...
		trainingModal = webData.getModalForm(request, "50:0");
		webData.close();
	}
...
<head>
    ...
    <link href="./assets/admin/layout4/css/custom.css?1040" rel="stylesheet" type="text/css"/>
...
<h2 style="
    margin-bottom: -50px;
    margin-left: 45%;font-weight: bold;color:#0072b8">COURSE DETAILS</h2>
</div>
...
<!-- BEGIN CONTAINER -->
<div class="page-container" style="margin-top: 0px;background-color: white;">
    

	<!-- BEGIN CONTENT -->
	<div class="page-content-wrapper">
		<div class="page-content" style="margin-left: 0px;padding:0">
				...
				<div class="portlet light bordered" style="border: none !important;box-shadow: none;padding-top: 0px;">
				    ...
				    <div class="portlet-body">
                       <!-- START OF SINGLE JOB  SECTION -->
                        <section class="single_training" id="tableid">
	                        <div class="row">
	                            <div class="small-12 columns">
	                                <div id="course_title" class="training_title" style="font-size: 27px;font-weight: bold;">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
									<a href="./trainings.jsp"><button class="allcbtn">VIEW ALL COURSES</button></a>

									<hr style="border-top: 2px solid #0072b8;width: 50px;margin-top: 10px;margin-bottom: 20px;">
									<div class="img-tbl" style="display:flex">
										<div id="top-img" style="max-width:600px;width:100%;background-image: url(https://img.freepik.com/premium-photo/stack-books-desk-back-school_488220-35508.jpg?w=740);background-size: cover;">
											<div id="topic-img" style="max-width:600px;width:100%;height:373px;"></div>
										</div>
										<div class="table-container">
											<ul class="responsive-table">
											  <li class="table-header">
												<div style="margin:auto">Online Course Details</div>
											  </li>
											  <li class="table-row">
												<div class="col col-1" data-label="Training Date">Duration (Days)</div>
												<div class="col col-2" id="start_date" data-label="Date"></div>
											  </li>
											  <li class="table-row">
												<div class="col col-1" data-label="Training Time">Duration (Hours)</div>
												<div class="col col-2" id="start_time" data-label="Time"></div>
											  </li>
											  <!-- <li class="table-row">
												<div class="col col-1" data-label="Training Close">End Time</div>
												<div class="col col-2" id="end_time" data-label="Time"></div>
											  </li> -->
											  <li class="table-row">
												<div class="col col-1" data-label="Training By">Instructor</div>
												<div class="col col-2" id="training_by" data-label="Name"></div>
											  </li>
											</ul>
										  </div>
									</div>
	                        ...
	                        <div class="row">
								<h4 style="font-weight: bold;">COURSE OVERVIEW</h4>
								<hr style="border-top: 2px solid #0072b8;width: 50px;margin-top: 10px;margin-bottom: 20px;">
								<div id="training_details" class="training_details" style="font-size: 15px;">
									<i class="fas fa-sync fa-spin"> </i>
								</div>
                            ...
                            <div class="row">
                            	...
                            	<div class="small-12 large-6 columns" id="entreremail" style="margin-top: 35px;">
                                    <label style="font-size: 15px;"> 
                                        <input type="text" name="application_email" id="application_email" placeholder="Email *" required="required" style="
										...
										<!-- <div class="nf-field-element"> -->
											<input id="nf-field-4" 
											 ...
											 class="ninja-forms-field nf-element" type="button" value="REGISTER NOW"  style="
...
<script type="text/javascript" src="./assets/js/course_details.js?1070"></script>
...
<script type="text/javascript">
	...
	console.log(getCurrentUrlParameter());
	function training_application() {
		var isValid = false;

		console.log("Check validation");
		
		let training_course_id = getCurrentUrlParameter();
		let applicant_email = $('#application_email').val();
		// let training_course_id = $('#training_course_id').val();
		applicant_email = applicant_email.trim();
		applicant_email = applicant_email.toLowerCase();
				
		console.log(applicant_email);
		console.log(training_course_id);
		
		let valid_email = validateEmail(applicant_email);
		if(valid_email) {
		
			let emailUrl = "./training?tag=search_training_email&email=" + applicant_email + "&training_course_id=" + training_course_id;
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(data.success == 0) {
						...
						$('#primary_email').val(applicant_email);
						$('#primary_email').attr('readonly', true);
						$('#training_course_id').val(training_course_id);
						$('#training_course_id').attr('readonly', true);
						$('#modal_training').modal('show');
						// let applyUrl = "./training?tag=apply_training";
							
						// var formData = {email:applicant_email, entity_id:data.entityId, training_course_id:training_course_id}; 
	...
	$("#btn_application").click(function(e) {
		...
		$.post('ajaxinsert', {app_xml:app_xml, app_key:'1:0', form_data:form_data}, function(data) {
			...
			if(data.error == 0) {
				...
				var formData = {email:data.data.applicant_email, entity_id:data.data.keyfield, training_course_id:training_course_id}; 
	...
	$("#btn_training").click(function(e) {
		if( !validate($("#frm_training").serializeArray()) ) {return;}	
		var form_data = JSON.stringify($("#frm_training").serializeArray());
		$.post('ajaxinsert', {app_xml:app_xml, app_key:'50:0', form_data:form_data}, function(data) {
			console.log(data);
