<%@ page import="java.util.Vector" %>
	...
	StringBuilder ctrys = new StringBuilder();
	Vector<Vector<String>> countries = db.readTable("sys_country_id, sys_country_name", "sys_countrys ORDER BY sys_country_name");
	for(Vector<String> country : countries) {
		ctrys.append("<option value='" + country.get(0) + "'");
		if(country.get(0).equals("KE")) ctrys.append(" selected='selected'");
		ctrys.append(">" + country.get(1) + "</option>\n");
    }

    StringBuilder inda = new StringBuilder();
    Vector<Vector<String>> industrys = db.readTable("industry_id, industry_name", "industry ORDER BY industry_name");
    for(Vector<String> industry : industrys) inda.append("<option value='" + industry.get(0) + "'>" + industry.get(1) + "</option>\n");
            ...
            <body class="shiftnav-enabled shiftnav-lock shiftnav-disable-shift-body">
                ...
                <div class="off-canvas-wrapper">
                            ...
                            <div id="inner-content" class="row">
                                ...
                                <main id="main" class="large-12 medium-12 columns first" role="main">
                                    ...
                                    <section class="single_job">
                                        ...
                                        <div class="row">
                                            <div class="small-12 columns">
                                                <div class="single_job_ref">
                                                    <i class="fas fa-sync fa-spin"> </i>
                                                </div>
                                                <div class="single_job_location">
                                                    <i class="fas fa-sync fa-spin"> </i>
                                                </div>
                                                <div class="single_job_category">
                                                    <i class="fas fa-sync fa-spin"> </i>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="small-12 columns">
                                                <div class="single_job_details">
                                                    <i class="fas fa-sync fa-spin"> </i>
                                                </div>

                                            </div>
                                            <!-- <div class="small-12 large-6 large-offset-3 columns pull-left"> -->
                                            <div class="small-12 large-6 columns pull-left">
                                                <div class="small-12 large-6 columns">
                                                    <div class="nf-field-element">
                                                        <input id="nf-field-4" data-open="appyToday" class="ninja-forms-field nf-element" type="button" value="APPLY NOW">
                                                    </div>
                                                </div>
                                                <div class="small-12 large-6 columns" style="display: none;">
                                                    <div class="nf-field-element">
                                                        <input id="nf-field-4" class="ninja-forms-field nf-element " type="button" value="APPLY NOW">
                                                    </div>
                                                </div>
                                    ...
                                    <!-- Application Modal -->
                                    <div class="large reveal" style="" id="appyToday" data-reveal data-animation-in="spin-in" data-animation-out="spin-out">
                                        <ul class="tabs" data-tabs id="application-tabs" style="margin-top: 40px;">
                                            <li class="tabs-title is-active"><a href="#registration" aria-selected="true"><b>Registration & Apply</b></a></li>
                                            <li class="tabs-title"><a href="#sign-in"><b>Already Have An Account</b></a></li>
                                        </ul>
                                        <div class="tabs-content" data-tabs-content="application-tabs">
                                            <!-- Application Tab -->
                                            <div class="tabs-panel is-active" id="registration">
                                                <!-- <h1 style="font-size: 1.2rem;color : #db8b00;">Register New Account</h1>
                                                <hr> -->
                                                <div id="frmRegApplicantAlert"></div>
                                                <form id="frm_application">
                                                    <div class="grid-container">

                                                        <div class="grid-x grid-padding-x">
                                                            <div class="small-12 large-4 columns">
                                                                <label> Email
                                                                    <input type="text" name="applicant_email" id="applicant_email" placeholder="Email *" required="required">
                                                                    <input type="hidden" name="job_id" id="job_id" value="" >
                                                                </label>
                                                            </div>
                                                            <div class="small-12 large-4 columns">
                                                                <label> Phone
                                                                    <input type="text" name="applicant_phone" placeholder="Phone *" required="required">
                                                                </label>
                                                            </div>
                                                            <div class="small-12 large-4 columns">
                                                                <label>Title
                                                        ...
                                                        <div class="grid-x grid-padding-x">
                                                            <div class="small-12 large-4 columns dob">
                                                                <label> Date of Birth
                                                                    <input  type="date" name="date_of_birth"  id="date_of_birth" placeholder="Date of Birth *" required="required">
                                                                </label>
                                                            </div>
                                                            <div class="small-12 large-4 columns">
                                                                <label> Nationality *
                                                        ...
                                                        <div class="grid-x grid-padding-x">
                                                            <div class="small-12 large-4 columns">
                                                                <label> Identity Card Number *
                                                                    <input type="text" name="identity_card" placeholder="Identity Card Number *" required="required">
                                                                </label>
                                                            </div>
                                                            <div class="small-12 large-4 columns">
                                                                <label> Language *
                                                ...
                                                <div class="small-12 large-6 columns pull-left">
                                                    <div class="small-12 large-6 columns">
                                                        <div class="nf-field-element">
                                                            <input id="nf-field-4" class="btn_application ninja-forms-field nf-element" type="button" value="APPLY">
                                                        </div>
                                                    </div>
                                                </div>

                                            </div>
                                            <div class="tabs-panel" id="sign-in">
                                                <!-- <h1 style="font-size: 1.2rem;color: #db8b00;">Sign In</h1>
                                                <hr> -->
                                                <div id="frmSignAlert"></div>
                                                <form id="frm_sign_in">
                                                    <div class="grid-container">
                                                        <div class="grid-x grid-padding-x">
                                                            <div class="small-12 large-6 columns">
                                                ...
                                                <div class="small-12 large-6 columns pull-left">
                                                    <div class="small-12 large-6 columns">
                                                        <div class="nf-field-element">
                                                            <input id="nf-field-4" class="btn_sign_in ninja-forms-field nf-element" type="button" value="SEND LINK">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <script type="text/javascript">
                        ...
                        // });
                        // $("#date_of_birth").data('DateTimePicker').setLocalDate(new Date(year, month, day, 00, 01));
                    </script>
            </body>
