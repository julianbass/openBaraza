...
<head>
	...
	<link rel="stylesheet" href="./assets/bts/css/style.css?10">
...
<!-- END HEAD -->
<!-- BEGIN BODY -->
<body style="background-image: url('./assets/bts/images/backgroud.jpg') !important; background-size: cover !important;">
			...
			<div class="row justify-content-center">
				<div class="col-md-7 col-lg-5">
					<div class="login-wrap p-4 p-md-5">
						<center><img src="./assets/bts/images/logo.png" width="180px" style="margin-bottom: 35px;"></center>
...
<!-- END PAGE LEVEL PLUGINS -->
  <script src="./assets/bts/js/main.js"></script>
