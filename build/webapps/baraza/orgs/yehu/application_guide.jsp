...
<div class="page-header navbar navbar-fixed-top" style="border-bottom: none;background-color: #022a30;padding: 16px 0px 16px 0px;height: 116px;">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
				<img src="../assets/yehu/images/logo.jpg" alt="logo" style="margin: 20px 10px 0 10px; width: 107px;" class="logo-default"/>
			</a>
		...
		<h2 style="color:#fff;margin-left: 40%;font-weight: bold;">APPLICATION GUIDE</h2>
...
<div class="page-container" style="margin-top: 115px;background-color: white;">
	...
	<div class="page-content-wrapper" >
		<div class="page-content" style="font-size: 15px;display:flex;flex-wrap: wrap;gap:50px">
            <div style="width:50%">
                <img src="../assets/images/applicant.png" width="100%"/>
            </div>
            <div style="margin-top: 5%;">
                <p>Log in on the system using the credentials sent your email address. </p>
                <ul>
                    <li>On the left side, go to service desk.</li>
                    <li>Click on my details.</li>
                    <li>You will now be able to see your bio data.</li>
                </ul>
            </div>
            <div style="width:45%;margin-top: 8%;">
                <p>Now, we need you to  complete your profile. To do so , scroll down and you will see address, employment etc.</p>
            </div>
            <div style="width:50%">
            ...
            <div style="margin-top: 2.5%;">
                <ul>
                    <li>Click on the field to add the details.</li>
                    <li>Click on “+” to add.</li>
                    <li>Input the details then click on save icon.</li>
                </ul>
            </div>
            <div style="width:45%;margin-top: 8%;">
                <p>As you update your profile, click on <My CV> tab to view if your information has been updated.</p>
            </div>
            <div style="width:50%">
                <img src="../assets/images/cv.png" width="100%"/>
            </div>
        </div>
		<!-- END CONTENT -->
	</div>
