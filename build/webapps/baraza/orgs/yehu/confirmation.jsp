...
<%
	...
	if(code != null) {
		...
		entityId = db.executeFunction(mySql);
		
		if(entityId == null) {
			mySql = "SELECT entity_id FROM interns WHERE (confirmation_code = '" + code + "')";
			entityId = db.executeFunction(mySql);
			
			if(entityId != null) optId = 2;
		} else {
			optId = 1;
		}
	}
	...
	if(entityId != null) {
		String mySql = "SELECT applicants.home_county,  "
		...
		if(optId == 1) {
			if(msg.equals("")) {
				...
				msg1 = "Confirmation pending; Kindly login and update manditiory details";
				msg2 = msg;
			}
		} else if(optId == 2) {
			if(msg.equals("")) {
...
<div>
<h2 style="margin-bottom: -50px; margin-left: 45%; font-weight: bold; color:#0072b8">Confirmation page</h2>
</div>
					...
					<div class="portlet-body">
						...
						<section class="results">
							...
							<div class="row">
							    <div class="small-12 columns" id="client_job_list">
							        <i class="fas fa-sync fa-spin"> </i>
							        <p><a href="../index.jsp">Click here to login to the career portal to update your details</a></p>
							    </div>
							</div>
						</section>
