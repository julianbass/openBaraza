...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="./assets/admin/layout4/css/custom.css?2419" />
...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner">
		...
		<div class="page-logo">
			<a href="index.jsp">
			<img src="./assets/yehu/images/logo.jpg" alt="logo" style="margin: 2px 10px 0 30px; width: 45%;" class="logo-default"/>
			</a>
...
<script>
    ...
    jqcf.rowNum = 100;
    jqcf.height = 300;
    jqcf.rowList = [100,200,300,400,500];
    jqcf.datatype = "json";
    jqcf.pgbuttons = true;
