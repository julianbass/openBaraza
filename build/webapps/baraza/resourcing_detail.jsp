				    ...
				    <div class="portlet-title">
				        <div class="caption font-green-sharp">
				            ...
				            <c:if test="${param.work_type eq '1'}">
				            	<span class="caption-helper">Consultancy Details</span>
				            </c:if>
				            <c:if test="${param.work_type eq '2'}">
				            	<span class="caption-helper">Part Time Work Details</span>
				            </c:if>
				            <c:if test="${param.work_type eq '3'}">
				            	<span class="caption-helper">Volunteer Details</span>
				            </c:if>
				        </div>
				        <div class="actions">
				            <a href="javascript:;" class="btn btn-circle btn-default btn-icon-only fullscreen"></a>
                        ...
                        <section class="single_job">
	                        <div class="row">
	                            <div class="small-12 columns">
	                                <div id="single_opportunity_title" class="recruitment_title">
	                        ...
	                        <div class="row">
	                            <div class="small-12 columns">
	                                <div id="single_opportunity_ref" class="recruitment_narration">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
	                                <div id="single_opportunity_location" class="recruitment_narration">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
	                                <div id="single_opportunity_category" class="recruitment_narration">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
	                                <div id="single_opportunity_industry" class="recruitment_narration">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
	                                <div id="single_opportunity_positions" class="recruitment_narration">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
	                                <div id="single_opportunity_closing" class="recruitment_narration">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
	                            </div>
	                        </div>
	                        <div class="row">
	                            <div class="small-12 columns">
	                                <div id="single_opportunity_summary" class="recruitment_details">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
									<div id="single_opportunity_requirements" class="recruitment_details">
	                                    <i class="fas fa-sync fa-spin"> </i>
	                                </div>
	                            </div>
	                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="small-12 large-6 columns">
                                    <div class="nf-field-element">
                                        <input id="nf-field-4" 
                                         onclick="opportunity_application()"
...
<script type="text/javascript" src="./assets/js/recruitment_detail.js?1064"></script>
...
<script type="text/javascript">
	...
	function opportunity_application() {
		var isValid = false;
		...
		let application_pricing = $('#application_pricing').val();
		let applicant_comments = $('#applicant_comments').val();
		...
		if(valid_email) {
			...
			let emailUrl = "./recruitment?tag=search_opportunity_email&email=" + applicant_email + "&opportunity_id=" + job_id;
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(data.success == 0) {
						...
						let applyUrl = "./recruitment?tag=apply_opportunity";
							
						var formData = {email:applicant_email, entity_id:data.entityId, opportunity_id:job_id, application_pricing:application_pricing, applicant_comments:applicant_comments}; 
	...
	$("#btn_application").click(function(e) {
		...
		$.post('ajaxinsert', {app_xml:app_xml, app_key:'1:0', form_data:form_data}, function(data) {
			...
			if(data.error == 0) {
				...
				var formData = {email:data.data.applicant_email, entity_id:data.data.keyfield, opportunity_id:job_id, application_pricing:application_pricing, applicant_comments:applicant_comments}; 
