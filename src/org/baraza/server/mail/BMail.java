...
public class BMail {
	...
	public BMail(BElement root, BLogHandle logHandle) {
		...
		String smtpssl = root.getAttribute("smtpssl", "false");
		String ntlm = root.getAttribute("ntlm", "false");
		String ntlmDomain = root.getAttribute("ntlm.domain", "WINDOMAIN");
		...
		try {
			...
			if (ntlm.equals("true")) {
				...
				props.setProperty("mail.smtp.auth.ntlm.domain", ntlmDomain);
			} else {
