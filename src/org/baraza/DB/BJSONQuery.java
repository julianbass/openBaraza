...
public class BJSONQuery extends BQuery {
	...
	public String getJSONData(String viewKey, boolean sfield) {
		...
		//System.out.println(myJa.toString());
	...
	public String getSelectKey() {
		...
		for(BElement sview : view.getElements()) {
			...
			if(sviewName.equals("ACCORDION") || sviewName.equals("DIARY") || sviewName.equals("DIARYEDIT") || sviewName.equals("FILES") || sviewName.equals("FORM") || sviewName.equals("GRID") || sviewName.equals("JASPER") || sviewName.equals("FORMVIEW") || sviewName.equals("APPROVALFORM") || sviewName.equals("CROSSTAB")) {
