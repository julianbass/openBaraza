...
public class BWebData {
	...
	/* Generate a modal form View */
	public String getModalFormView(HttpServletRequest request, String viewKey) {
		view = root.getView(viewKey);
		//System.out.println(view);

		String title = view.getAttribute("title");
		String formId = view.getAttribute("form.id");
		String buttonAction = view.getAttribute("button.action");
		...
		+ "	      </div>"
		+ "	      <div class='modal-body'>"
		+ "	        <div class='table-scrollable table-responsive table-bordered viewform'>\n"
		...
		for(BElement el : view.getElements()) {
			...
			modalFormHtml += "<tr><td><b>" + fieldTitle + "</b></td>";
			modalFormHtml += "<td id='td_" + el.getValue() + "'></td></tr>\n";
		}
		...
		if(buttonAction != null) {
			modalFormHtml += "	        <button type='button' class='btn btn-primary' id='btn_"
				+ formId + "'>" + buttonAction + "</button>";
		}
