...
public class Bajax extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) { 
		...
		if(sp.equals("/ajaxupdate")) {
			...
			resp = callOperation(id, ids, request);
		} else if("approval".equals(fnct)) {
			resp = callApproval(id, request);
	...
	public String updateGrid(HttpServletRequest request) {		
		...
		for(BElement el : view.getElements()) {
			if(el.getName().equals("EDITFIELD")) {
				...
				if(dataValue.trim().equals("")) upSql += el.getValue() + " = null";
				else upSql += el.getValue() + " = '" + dataValue + "'";
				hasEdit = true;
			}
		}
...
System.out.println(calId);
	...
	public String callOperation(String id, String ids, HttpServletRequest request) {
		String resp = "";
		...
		if(ids == null) {
			...
			resp = web.setOperations(id, ids, request);
		}

		return resp;
	}

	public String callApproval(String id, HttpServletRequest request) {

		String resp = web.setOperations(id, null, request);
		return resp;
	}
